package com.example.penguin.lab5;
...
public class MainActivity extends AppCompatActivity {
    ...
    private  void showToast(){
        ...
        toast.setGravity(Gravity.TOP,-20,330);
        toast.setDuration(Toast.LENGTH_SHORT);
        LayoutInflater inflater = getLayoutInflater();
        View layout = getLayoutInflater().inflate(R.layout.activity_custom_toast,
    ...
    private  void showListDialog(){
        final String[] list_item = {"message1","message2","message3","massage4","message5"};
